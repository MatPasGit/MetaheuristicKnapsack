...
wyniki = []
wyniki = [0 for i in range(72)]

wynikiczasowe = []
wynikiczasowe = [0 for i in range(72)]
...
def main():
    ...
    neighbourmethod = 1    #Wybór sąsiada: 1 - wybór najlepszego sąsiada przy zamianie jednego elementu na jeden, 2 - przy zamianie jednego elementu na więcej

    for item_list_size in range(3,30,5):
        for iterations in range(200,500,100):
            for init_method in [1,2]:
                for neighbourmethod in [1,2]:
    ...
    plt.plot(argumenty, wyniki[1::12], label="200 - 1 - 2")
    plt.plot(argumenty, wyniki[2::12], label="200 - 2 - 1")
    plt.plot(argumenty, wyniki[3::12], label="200 - 2 - 2")
    plt.plot(argumenty, wyniki[4::12], label="300 - 1 - 1")
    plt.plot(argumenty, wyniki[5::12], label="300 - 1 - 2")
    plt.plot(argumenty, wyniki[6::12], label="300 - 2 - 1")
    plt.plot(argumenty, wyniki[7::12], label="300 - 2 - 2")
    plt.plot(argumenty, wyniki[8::12], label="400 - 1 - 1")
    plt.plot(argumenty, wyniki[9::12], label="400 - 1 - 2")
    plt.plot(argumenty, wyniki[10::12], label="400 - 2 - 1")
    plt.plot(argumenty, wyniki[11::12], label="400 - 2 - 2")
    ...
    plt.plot(argumenty, wynikiczasowe[1::12], label="200 - 1 - 2")
    plt.plot(argumenty, wynikiczasowe[2::12], label="200 - 2 - 1")
    plt.plot(argumenty, wynikiczasowe[3::12], label="200 - 2 - 2")
    plt.plot(argumenty, wynikiczasowe[4::12], label="300 - 1 - 1")
    plt.plot(argumenty, wynikiczasowe[5::12], label="300 - 1 - 2")
    plt.plot(argumenty, wynikiczasowe[6::12], label="300 - 2 - 1")
    plt.plot(argumenty, wynikiczasowe[7::12], label="300 - 2 - 2")
    plt.plot(argumenty, wynikiczasowe[8::12], label="400 - 1 - 1")
    plt.plot(argumenty, wynikiczasowe[9::12], label="400 - 1 - 2")
    plt.plot(argumenty, wynikiczasowe[10::12], label="400 - 2 - 1")
    plt.plot(argumenty, wynikiczasowe[11::12], label="400 - 2 - 2")
